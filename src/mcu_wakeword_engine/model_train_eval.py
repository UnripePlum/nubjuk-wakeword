...
import mcu_wakeword_engine.data as input_data
import mcu_wakeword_engine.train as train
import mcu_wakeword_engine.test as test
import mcu_wakeword_engine.utils as utils

import mcu_wakeword_engine.inception as inception
import mcu_wakeword_engine.mixednet as mixednet

from mcu_wakeword_engine.layers import modes
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--training_config",
        type=str,
        default="models/model/train/training_parameters.yaml",
        help="""\
